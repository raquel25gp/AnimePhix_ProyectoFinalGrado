...
@Component({
  selector: 'app-cuentas-admins',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './cuentas-admins.component.html',
  styleUrl: './cuentas-admins.component.css'
})
export class CuentasAdminsComponent {
  @Input() listadoAdmins: any[] = [];
  mensaje: string = '';
  ...
  cambiarRol(usuario: any) {
    ...
    this.usuarioService.generarAdmin(idUsuario, email).subscribe({
      next: () => {
        ...
        this.mensaje = "El Administrador ha pasado a ser un Usuario normal.";
